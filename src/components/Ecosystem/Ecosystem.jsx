...
const Ecosystem = () => {
  ...
  <div className="flex items-start gap-8">
    ...
    <p className="text-gray-400 text-[17px] leading-[30px] max-w-[480px]">
      Earn rewards through referrals, staking, and liquidity, while leveraging
      AI infrastructure and seamless global connectivity for scalable blockchain
      operations and decentralized financial growth worldwide.
    </p>

    <button className="min-w-[56px] h-[56px] mt-14 flex items-center justify-center 
  ...
  {/* TOP RIGHT */}
<div className="absolute top-[90px] right-[40px] w-[350px] h-[170px]
  border border-red-600 rounded-full px-6 py-4 
  ...
  <ul className="text-gray-400 text-[11px] leading-5">
  ...
  {/* CENTER LEFT */}
  <div className="absolute top-[210px] left-[3px]  w-[350px] h-[170px]
    border border-red-600 rounded-full px-6 py-4 
    bg-black/30 backdrop-blur-sm  flex flex-col justify-center items-center text-center">
  ...
  {/* BOTTOM RIGHT */}
  <div className="absolute bottom-[130px] right-[20px]  w-[350px] h-[170px]
    border border-red-600 rounded-full px-6 py-4 
    bg-black/30 backdrop-blur-sm  flex flex-col justify-center items-center text-center">
  ...
  {/* BOTTOM LEFT */}
  <div className="absolute bottom-[10px] w-[350px] h-[170px] left-[5px] 
    border border-red-600 rounded-full px-6 py-4 
    bg-black/30 backdrop-blur-sm  flex flex-col justify-center items-center text-center">
